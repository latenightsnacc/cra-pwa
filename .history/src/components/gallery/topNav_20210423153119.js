    ...
    return (
        <nav className="w-full flex flex-row justify-between py-5">
            ...
            <div className="flex">
                ...
                <select name="sort">
                    <option selected={true} className="hidden md:block flex  items-center text-lg  md:mr-3 text-gray-400"><i className="fas fa-arrow-up"></i>
                    <i className="fas fa-arrow-down"></i>
                    <span className="px-1">Sort by</span></option>
                    <option>Option 1</option>
                    <option>Option 1</option>
                </select>
                
                 {/* PRICE SELEECT OPTIONS */}
                <button className="hidden md:block flex justify-center items-center text-lg text-black" onClick={this.onClickButton}>
                    <span>Price</span>
                    <i className="fas fa-chevron-down"></i>
                </button>
                {/* Select Options */}

                <select name="price" className={this.state.display}>
                    <option>Option 1</option>
                    <option>Option 1</option>
                    <option>Option 1</option>
                </select>
