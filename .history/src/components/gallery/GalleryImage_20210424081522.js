...
export default function GalleryImage() {
    return (
        <div className="w-64  mb-5">
            ...
            {/* <!--Image Price--> */}
            <div className="text-gray-600  flex flex-row justify-start h-8 items-center"> <span className="text-sm"><i className="fas fa-dollar-sign"></i></span><span className="text-xl">3.98</span></div>     
        </div>
    )
}
