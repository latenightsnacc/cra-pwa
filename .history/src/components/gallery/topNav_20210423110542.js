    ...
    return (
        <nav className="flex flex-row justify-between py-5">
            ...
            <ul className="flex flex-row">
                <li className="hidden md:block flex  items-center text-lg md:mr-3 text-gray-400">
                    <span className="material-icons-outlined">import_export</span>
                    <span>Sort by</span>
                </li>
                <li className="hidden md:block flex justify-center items-center  h-16 text-lg text-black">
                    <span>Price</span>
