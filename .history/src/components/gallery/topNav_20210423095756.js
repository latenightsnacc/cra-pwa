                    ...
                    <div className="pt-3 pl-0">
                        <ul className="pl-0 pb-3">
                                    ...
                                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                                        ...
                                        Lower than <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>20
                                    </li>
                                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                                        <span className="material-icons-outlined mr-3">
                                        check_box_outline_blank
                                        </span> 
                                        <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>20 - <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>100
                                    </li>
                                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                                        <span className="material-icons-outlined mr-3">
                                        check_box_outline_blank
                                        </span> 
                                        <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>100 - <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>200
                                    </li>
                                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                                        <span className="material-icons-outlined mr-3">
                                        check_box_outline_blank
                                        </span> 
                                        More than <span className="ml-1 font-semibold text-sm material_icons_outline">attach_money</span>200
                                    </li>
                                </ul>
                            </div>
                            {/* <!--CONTROL BUTTONS--> */}
