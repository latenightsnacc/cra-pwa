            ...
            <div className="hidden md:block pt-3 w-full">
                <ul className="pl-0 pb-3">
                    ...
                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                        ...
                        <span className="ml-1 font-semibold text-sm material-icons-outlined"><i className="fas fa-dollar-sign"></i></span>20 - <span className="ml-1 font-semibold text-sm material-icons-outlined"><i className="fas fa-dollar-sign"></i></span>100
                    </li>
                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                        <span className="material-icons-outlined mr-3" key={3}  onClick={this.handleClick}>{this.state.checkBox}</span> 
                        <span className="ml-1 font-semibold text-sm material-icons-outlined"><i className="fas fa-dollar-sign"></i></span>100 - <span className="ml-1 font-semibold text-sm material-icons-outlined"><i className="fas fa-dollar-sign"></i></span>200
                    </li>
                    <li className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                        <span className="material-icons-outlined mr-3" key={4}  onClick={this.handleClick}>{this.state.checkBox}</span> 
                        More than <span className="ml-1 font-semibold text-sm material-icons-outlined"><i className="fas fa-dollar-sign"></i></span>200
                    </li>
