  ...
  render() {
    ...
    return (
        <nav className="w-full flex flex-row justify-between py-5">
            <div className="text-xl md:text-2xl xl:text-3xl text-black font-bold">Photography/<span className="text-gray-300 text-xl md:text-2xl md:text-3xl font-normal"> Premium Photos</span></div>
            <div className="flex">
