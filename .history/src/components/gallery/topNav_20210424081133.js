  ...
  render() {
    ...
    return (
        <nav className="w-full flex flex-row justify-between py-5">
            <div className="text-lg md:text-2xl xl:text-3xl text-black font-bold">Photography/<span className="text-gray-300 text-2xl md:text-3xl font-normal"> Premium Photos</span></div>
            <div className="flex">
