        ...
        <div className="hidden md:block mr-10 border-b-2 border-b-gray-300">
            <ul className="pl-0 pb-5">
                ...
                <label className="checkbox relative flex flex-row items-center mb-4">
                    ...
                    <span className="text-2xl ml-3 text-black flex flex-row items-center capitalize">People</span>
                </label> 
                <label className="checkbox relative flex flex-row items-center mb-4">
                    <input className="h-5 w-5 appearance-none border-2 cursor-pointer border-black outline-none font-bold bg-white" type="checkbox" />
                    <span className="text-2xl ml-3 text-black flex flex-row items-center capitalize">premium</span>
                </label> 
                <label className="checkbox relative flex flex-row items-center mb-4">
                    <input className="h-5 w-5 appearance-none border-2 cursor-pointer border-black outline-none font-bold bg-white" type="checkbox" />
                    <span className="text-2xl ml-3 text-black flex flex-row items-center capitalize">pets</span>
                </label> 
                <label className="checkbox relative flex flex-row items-center mb-4">
                    <input className="h-5 w-5 appearance-none border-2 cursor-pointer border-black outline-none font-bold bg-white" type="checkbox" />
