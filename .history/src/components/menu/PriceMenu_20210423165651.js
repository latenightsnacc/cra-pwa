            ...
            <div className="hidden md:block pt-3 w-full">
                <ul className="pl-0 pb-3">
                    ...
                    <label className="checkbox relative">
                        <input className="h-6 w-6 appearance-none border-2 cursor-pointer border-black outline-none bg-white" type="checkbox" />
                        <span>Check Me</span>
                    </label>
                    <label className="flex flex-row items-center space-around  text-2xl text-black mb-4">
                            ...
                            <div className="w-30 h-30 relative">
                                ...
                                <div className="checkmark h-6 w-6 border-2 border-black opacity-20"></div>
                            </div>
