            ...
            <div className="hidden md:block pt-3 w-full">
                <ul className="pl-0 pb-3">
                    ...
                    <label className="checkbox relative flex flex-row items-center">
                        ...
                        <span className="text-2xl ml-2 text-black flex flex-row items-center">Lower than <span className="ml-1 font-light text-xs"><i className="fas fa-dollar-sign"></i></span>20</span>
                    </label>
